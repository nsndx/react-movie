   ...
   return (
      ...
      <p className="text-xl text-center mb-10">Trang cá nhân</p>
         <div className='text-lg font-semibold border-b pb-3 flex'>
            ...
            <div className="pl-5">
               <p><span>Tài khoản: </span><span className='text-amber-500 mr-2'>{ttTaiKhoan?.taiKhoan}</span><span className="text-blue-500 text-sm">( {ttTaiKhoan?.loaiNguoiDung} )</span></p>
