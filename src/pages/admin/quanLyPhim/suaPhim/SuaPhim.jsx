         ...
         <div className='flex'>
            ...
            <form onSubmit={handleSubmitForm} className='flex-1'>
               ...
               <div className='flex mb-2'>
                  ...
                  <input {...register('trailer')} type="text" className="flex-1 border border-gray-500 focus:outline-none px-2 py-[2px] focus:border-blue-600 " />
                  <p className='m-0 text-red-500 h-5 pl-2 w-60'></p>
               </div>
               {/* Mô tả */}
               <div className='flex mb-2'>
                  <p className='m-0 font-semibold w-40 text-right pr-2'>Mô tả: </p>
                  <textarea rows={3} {...register('moTa')} type="text" className="resize-none flex-1 border border-gray-500 focus:outline-none px-2 py-[2px] focus:border-blue-600 " />
                  <p className='m-0 text-red-500 h-5 pl-2 w-60'></p>
               </div>
               {/* Ngày khởi chiếu */}
               <div className='flex mb-2'>
