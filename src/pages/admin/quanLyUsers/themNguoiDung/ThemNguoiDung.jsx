...
export default function ThemNguoiDung() {
   ...
   return (
      <div className='ThemNguoiDung p-3'>
         <p className='font-bold text-xl mb-3'>Thêm người dùng</p>
         <form onSubmit={handleSubmit(data => dispatch(themNguoiDung({ ...data, maNhom: 'GP00' })))}>
            {/* Tài khoản */}
            <div>
            ...
            <div className="lg:text-right mt-3 flex justify-between">
               ...
               {addNguoiDung && !errAddNguoiDung ? '' : <button className="px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-800 transition duration-300">
                  Thêm người dùng
               </button>}
            </div>
         </form>
