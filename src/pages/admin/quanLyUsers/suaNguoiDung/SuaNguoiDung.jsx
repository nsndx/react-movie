...
import { capNhatThongTinNguoiDung, layDanhSachNguoiDung, quanLyNguoiDungActions } from '../../../../stores/quanLyNguoiDungReducer/quanLyNguoiDungReducer'

export default function SuaNguoiDung() {
   const { register, handleSubmit, reset } = useForm();
   const dispatch = useDispatch()
   const param = useParams()
   const { danhSachNguoiDung, errCapNhat, capNhat } = useSelector((state) => state.quanLyNguoiDungReducer);
   const nguoiDung = danhSachNguoiDung?.find(nguoidung => nguoidung.taiKhoan === param.id)
